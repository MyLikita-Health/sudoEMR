...
const DrugPurchaseReceipt = ({
  ...
  const amountPaid = customerInfo.amountPaid;
  const balance = parseInt(total) - parseInt(customerInfo.amountPaid);
  return (
    <>
      <Document>
        <Page size={{ width: 200 }} style={styles.body}>
          <View>
            <View style={styles.headerContainer}>
              ...
              />
              {/* <Text>{JSON.stringify(facilityInfo)}</Text> */}
            ...
            <View style={styles.item}>
              ...
              <View>
                <Text>
                  {modeOfPayment === "Deposit" ? "Out-Patient" : "Walk-In"}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.table}>
              ...
              {data.map((item, index) => (
                <View key={index} style={styles.tableRow}>
                  <View style={styles.tableCol1}>
                    <Text style={styles.tableCell}>{item.drugs}</Text>
                  </View>
              ...
              <View style={styles.tableRow}>
                ...
                <View style={[styles.tableColTotal, styles.fontWeightBold]}>
                  <Text style={[styles.tableCell, styles.textRight]}>
                    {`₦ ${(
                      parseInt(total) + parseInt(discount)
                    ).toLocaleString()}`}
                  </Text>
                </View>
              </View>
