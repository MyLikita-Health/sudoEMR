    ...
    <div className="row">
      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 ml-auto mr-auto mb-4">
        <div className="multisteps-form__progress">
          <TabItem
            title="Management"
            path={`/me/doctors/visits/new/${patientId}/management/plan`}
          ...
          <TabItem
            title="Dressing"
            path={`/me/doctors/visits/new/${patientId}/management/dressing`}
            done={checkEmpty(dressingRequest)}
          />
          <TabItem
            title="Complete   "
            path={`/me/doctors/visits/new/${patientId}/management/view`}
